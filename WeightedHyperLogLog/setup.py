...
setup(
    name='WHLL',
    version='2.0.3',
    description='WeightedHyperLogLog implementation in C for python.',
    ...
    keywords=['WeightedHyperLogLog', 'HyperLogLog', 'Hyper LogLog', 'Hyper Log Log', 'LogLog', 'Log Log', 'cardinality', 'counting', 'sketch'],
    license='MIT',
    long_description=\
"""
